...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/home/aiart/AUTOMI/ptv_ctv_transformation/Dataset2D/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='ptv_to_ctv', help='name of the experiment. It decides where to store samples and models')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='ptvtoctv', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
        ...
        # wandb parameters
        parser.add_argument('--use_wandb', default=False, action='store_true', help='if specified, then init wandb logging')
        parser.add_argument('--wandb_project_name', type=str, default='automi-cyclegan-ptvtoctv', help='specify wandb project name')
